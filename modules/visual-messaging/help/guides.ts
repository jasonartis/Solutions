...
7. Click **Draw a reply** to switch the picture into drawing mode — a blue
   border and a **Drawing mode** label appear so it's always clear swipes
   are off right now. Choose a tool: **Pen** (pick a color and size, then
   draw directly on the picture), **Emoji** (pick an emoji and a size, then
   tap the picture to drop it), **Text** (type your message, pick a
   color/size/angle, then tap the picture to place it), or **Image** (upload
...
9. Click **Send reply**. Your drawing becomes a new layer under the one you
   ...
   top of yours, it can't be edited — that's what keeps every reply's
   context intact.
`,
    },
    {
